...
// Sound
#define PD4WEB_PROJECT_NAME "pd-build"
...
static const char *PD4WEB_NUMBER_INPUT[] = {"floatatom","l.nbx",};
static int PD4WEB_NUMBER_INPUT_SIZE = 2;


static const char* PD4WEB_QWERTY_INPUT[] = {"symbolatom","listatom",};
static int PD4WEB_QWERTY_INPUT_SIZE = 2;
